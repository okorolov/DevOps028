...
bash /build_env/infrastructure/liquibase \
    --defaultsFile=/build_env/liquibase/liquibase.properties \
    --changeLogFile=/build_env/liquibase/changelogs/changelog-main.xml \
    --classpath=/build_env/infrastructure/postgresql-42.1.4.jar update
